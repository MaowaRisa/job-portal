    ...
    <div className="card card-compact bg-base-100 shadow-xl">
      ...
      <div className="card-body">
        ...
        <div className="flex justify-between mt-4">
            <h2 className="flex gap-1 items-end"><MdOutlineLocationOn className="text-2xl" /> {location}</h2>
            <h2 className="flex gap-1 items-end"><AiOutlineDollar className="text-2xl"/> {salary}</h2>
        </div>
